...
public class AirplaneService {
    ...
    public Airplane saveAirplane(Airplane airplane) {
        ...
        if (airplane.getId() != 0 && airplane.getPlate() != null ) {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Airplane doesn't have necessary attribute!");
        }
    }
    ...
    public Airplane updateAirplane(Airplane airplane) {
        ...
        if (airplane.getId() != 0 && airplane.getPlate() != null ) {
            if (airplaneRepository.existsById(airplane.getId())) {
                ...
                throw new ResponseStatusException(HttpStatus.CONFLICT, "Airplane Id doesn't match to update!");
            }
        } else {
