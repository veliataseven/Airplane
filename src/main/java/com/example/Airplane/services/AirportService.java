...
public class AirportService {
    ...
    public Airport saveAirport(Airport airport) {
        ...
        if(airport.getId() != 0 && airport.getName() != null) {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Airport doesn't have necessary attribute!");
        }
    }
    ...
    public Airport updateAirport(Airport airport) {
        if(airport.getId() != 0 && airport.getName() != null) {
            if(airportRepository.existsById(airport.getId())) {
                ...
                throw new ResponseStatusException(HttpStatus.CONFLICT, "Airport Id doesn't match to update!");
            }
        } else {
